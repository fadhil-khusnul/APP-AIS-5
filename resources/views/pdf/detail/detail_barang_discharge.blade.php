...
<body>
    ...
    <main>
        ...
        <table width ="100%" class="header2">
            ...
            <tr>
                <td>TANGGAL TIBA KAPAL</td>
                <td>:</td>
                <td>{{ \Carbon\Carbon::parse($load->tanggal_tiba)->isoFormat('dddd, DD MMMM YYYY') }}
                </td>
            </tr>
            <tr>
                <td>VESSEL/VOYAGE</td>
        ...
        <table class="bank" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($container['tanggal_kembali'])->isoFormat('dddd, DD-MMMM-YYYY') }}</td>
                    <td>
                        <ol type="1.">
