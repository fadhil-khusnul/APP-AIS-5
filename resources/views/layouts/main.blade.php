...
<body class="preload-active aside-active aside-mobile-minimized aside-desktop-maximized">
    ...
    {{-- @vite([
        'resources/assets/build/scripts/mandatory.js',
        'resources/assets/build/scripts/core.js',
        'resources/assets/build/scripts/vendor.js',
        'resources/assets/app/utilities/sticky-header.js',
        'resources/assets/app/utilities/copyright-year.js',
        'resources/assets/app/utilities/theme-switcher.js',
        'resources/assets/app/utilities/tooltip-popover.js',
        'resources/assets/app/utilities/dropdown-scrollbar.js',
        'resources/assets/app/utilities/fullscreen-trigger.js',
        'resources/assets/app/pages/home.js',
        'resources/assets/app/pages/datatable/extension/fixed-header.js',
        'resources/assets/app/pages/datatable/extension/search-panes.js',
        'resources/assets/app/pages/form/typeahead.js',
        'resources/assets/app/pages/form/datepicker.js',
        'resources/assets/app/pages/form/daterangepicker.js',
        'resources/assets/app/pages/form/select2.js',
        'resources/assets/app/pages/form/touchspin.js',
        'resources/assets/app/pages/form/inputmask.js',
        'resources/assets/app/pages/form/validation.js',
        'resources/assets/app/pages/elements/sweet-alert.js',
