            ...
            <div class="menu">
                ...
                <div class="menu-item">
                    ...
                    <div class="menu-submenu">
                        ...
                        <div class="menu-item">
                            <a href="elements/base/placeholder.html"
                                data-menu-path="/elements/base/placeholder.html" class="menu-item-link">
                                <i class="menu-item-bullet"></i>
                ...
                <div class="menu-item">
                    ...
                    <div class="menu-submenu">
                        ...
                        <div class="menu-item">
                            <a href="icons/feather.html" data-menu-path="/icons/feather.html"
                                class="menu-item-link">
                                <i class="menu-item-bullet"></i>
                ...
                <div class="menu-item">
                    ...
                    <div class="menu-submenu">
                        <div class="menu-item">
                            <a href="portlet/base.html" data-menu-path="/portlet/base.html"
                                class="menu-item-link">
                                <i class="menu-item-bullet"></i>
                                <span class="menu-item-text">Base</span>
                            </a>
                        ...
                        <div class="menu-item">
                            <a href="portlet/drag.html" data-menu-path="/portlet/drag.html"
                                class="menu-item-link">
                                <i class="menu-item-bullet"></i>
                        ...
                        <div class="menu-item">
                            <a href="portlet/tool.html" data-menu-path="/portlet/tool.html"
                                class="menu-item-link">
                                <i class="menu-item-bullet"></i>
                ...
                <div class="menu-item">
                    ...
                    <div class="menu-submenu">
                        ...
                        <div class="menu-item">
                            <a href="widgets/chart.html" data-menu-path="/widgets/chart.html"
                                class="menu-item-link">
                                <i class="menu-item-bullet"></i>
                ...
                <!-- END Menu Section -->
                <div class="menu-item">
                    <a href="chart/apex-chart.html" data-menu-path="/chart/apex-chart.html"
                        class="menu-item-link">
                        <div class="menu-item-icon">
                ...
                <div class="menu-item">
                    ...
                    <div class="menu-submenu">
                        ...
                        <div class="menu-item">
                            ...
                            <div class="menu-submenu">
                                <div class="menu-item">
                                    <a href="datatable/source/html.html"
                                        data-menu-path="/datatable/source/html.html" class="menu-item-link">
                                        <i class="menu-item-bullet"></i>
                ...
                <div class="menu-item">
                    ...
                    <div class="menu-submenu">
                        <div class="menu-item">
                            <a href="editor/basic.html" data-menu-path="/editor/basic.html"
                                class="menu-item-link">
                                <i class="menu-item-bullet"></i>
                                <span class="menu-item-text">Basic</span>
                            </a>
                        ...
                        <div class="menu-item">
                            <a href="editor/bubble.html" data-menu-path="/editor/bubble.html"
                                class="menu-item-link">
                                <i class="menu-item-bullet"></i>
                            ...
                            <div class="rich-list-prepend">
                                ...
                                <div class="avatar avatar-circle">
                                    ...
                                    <div class="avatar-display">
                                        <img src="{{ asset('/') }}./assets/images/avatar/blank.webp"
                                            alt="Avatar image">
                                    </div>
