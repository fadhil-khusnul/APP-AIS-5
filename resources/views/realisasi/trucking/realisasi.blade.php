            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="processtrucking" class="table mb-0 table-bordered table-striped table-hover autosize">
                                ...
                                @foreach ($truckings as $plandischarge)
                                    <tr>
                                        ...
                                        <td class="text-center text-nowrap">
                                            <a href="/truckingrealisasi-create/{{ $plandischarge->slug }}"
                                                class="btn btn-label-danger rounded-pill">Realisasi Trucking <i
