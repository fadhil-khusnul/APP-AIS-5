        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                <div class="text-end">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-vendor" class="btn btn-success btn-icon"> <i class="fa fa-plus"></i></a>
                </div>
                {{-- <p><strong>Fixed header</strong> can be initialised on a Datatable by using the <code>fixedheader</code> option in the Datatable options object.</p> --}}
                <hr>
                ...
                <table id="data_vendor" class="table table-bordered table-striped table-hover autosize">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><button onclick="editVendor(this)" value="{{$vendor->id}}" class="btn btn-label-info btn-icon btn-circle btn-sm"><i class="fa fa-pencil"></i></button>

                                <button onclick="deleteVendor(this)" value="{{$vendor->id}}" type="button" class="btn btn-label-danger btn-icon btn-circle btn-sm"><i
                                class="fa fa-trash"></i></button></td>
        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                <div class="text-end">
                    ...
                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-rekening"  class="btn btn-success btn-icon"> <i class="fa fa-plus"></i></a>
                </div>
                <hr>
