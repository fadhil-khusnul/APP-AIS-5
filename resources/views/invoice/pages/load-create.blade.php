                    ...
                    <tr>
                      ...
                      <td class="text-nowrap">
                        ...
                        @if ($pdf->status_si == 'Default')
                          <button data-id="{{ $pdf->container_id }}" data-bs-target="modal_invoice_si" type="button"
                            value="{{ $pdf->container_id }}" onclick="input_invoice_si(this)"
                            class="btn btn-success btn-sm ">Invoice <i class="fa fa-pencil"></i></button>
                        @else
                          <button data-id="{{ $pdf->container_id }}" data-bs-target="modal_invoice_si" type="button"
                            value="{{ $pdf->container_id }}" onclick="input_invoice_si_alih(this)"
                            class="btn btn-primary btn-sm ">Invoice Alih Kapal <i class="fa fa-ship"></i></button>
                        @endif
                        ...
                        <td class="text-center">
                          @if ($batal->price_invoice != null)
                            <button type="button" value="{{ $batal->id }}" type="button"
                              onclick="update_invoice(this)" class="btn btn-primary btn-sm "><i
                                class="fa fa-pencil"></i></button>
                          @else
                            <button type="button" value="{{ $batal->id }}" type="button"
                              onclick="input_invoice(this)" class="btn btn-success btn-sm text-nowrap ">Input <i
                                class="fa fa-pencil"></i></button>
                          @endif
                      ...
                      @if ($pdf_inv->tanggal_invoice != null)
                        <tr>
                          ...
                          <td class="text-nowrap text-center">
                            ...
                            @if ($pdf_inv->kirim == 0)
                              <button type="button" value="{{ $pdf_inv->id }}" onclick="kirim_invoice(this)"
                                class="btn btn-label-success btn-sm "><i class="bi bi-send-check-fill"></i></button>
                            @elseif ($pdf_inv->total - $pdf_inv->terbayar == 0)
                              <button type="button" value="{{ $pdf_inv->id }}" onclick="batal_kirim_invoice(this)"
                                class="btn btn-label-danger btn-sm "><i class="bi bi-send-dash-fill"></i></button>
                              <input readonly disabled checked type="checkbox" class="form-check-input"
                                id="kontainer_check[{{ $loop->iteration }}]">
                          ...
                          <td class="text-nowrap">
                            ...
                            <a type="button" href="/preview-invoice/{{ $pdf_inv->path }}"
                              class="btn btn-info btn-sm ">Invoice <i class="fa fa-eye"></i></a>

                            <button type="button" value="{{ $pdf_inv->id }}" onclick="delete_invoice(this)"
                  ...
                  @foreach ($reports as $report)
                    ...
                    <tr>
                      ...
                      <td class="text-nowrap text-center">
                        ...
                        <button type="button" value="{{ $report[0]->slug }}" onclick="delete_history(this)"
                          class="btn btn-danger btn-sm "><i class="fa fa-refresh"></i></button>
      ...
      <form class="modal-content" id="valid_invoice" name="valid_invoice">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-grid gap-3">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="price_invoice" name="price_invoice" placeholder="Unit Price..." onblur="blur_selisih(this)"
                    autofocus required>
            ...
            <div class="row">
              <label class="col-sm-4 col-form-label" for="">Selisih :<span class="text-danger">*</span></label>
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  <span class="input-group-text" for="">Rp.</span>
                  <input readonly data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
            ...
            <div class="row">
              <label for="" class="col-sm-4 col-form-label">Pilih Kondisi:<span
                  class="text-danger">*</span></label>
              <div class="col-sm-8 validation-container">
                <select data-bs-toggle="tooltip" id="kondisi_invoice" name="kondisi_invoice" class="form-select"
                  required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input readonly data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="total_price_invoice_si" name="total_price_invoice_si" placeholder="Total Unit Price..."
                    autofocus required>
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input autofocus required readonly data-bs-toggle="tooltip" type="text"
                    class="form-control currency-rupiah" id="total_biaya_kontainer_si" name="total_biaya_kontainer_si">
            ...
            <div class="row g-2">
              ...
              <div class="col-4 form-check g-3">
                <label class="form-check-label px-3" for="ppn">
                  <input class="form-check-input" type="radio" name="ppn_si" value="1" id="ppn_si"> Yes

                </label>
                <label class="form-check-label px-4" for="ppn_si">
                  <input class="form-check-input" type="radio" name="ppn_si" value="0" id="ppn_si"
                    checked> No
            ...
            <div class="row g-2">
              ...
              <div class="col-4 form-check g-3">
                <label class="form-check-label px-3" for="ppn2">
                  <input class="form-check-input" type="radio" name="materai_si" id="materai_si" value="1"
                ...
                <label class="form-check-label px-4" for="flexRadioDefault2">
                  <input class="form-check-input" type="radio" name="materai_si" id="materai_si" value="0"
                    checked onclick="document.getElementById('value_materai_si').disabled = true;"> No
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-grid gap-3 px-5">
            ...
            <div class="row g-2">
              ...
              <div class="col-4 form-check g-3">
                ...
                <label class="form-check-label px-4" for="ppn">
                  <input class="form-check-input" type="radio" name="ppn" value="0" id="ppn"
                    checked> No
            ...
            <div class="row g-2">
              ...
              <div class="col-4 form-check g-3">
                <label class="form-check-label px-3" for="ppn2">
                  <input class="form-check-input" type="radio" name="materai" id="materai" value="1"
                    onclick="document.getElementById('value_materai').disabled = false;"> Yes

                </label>
                <label class="form-check-label px-4" for="flexRadioDefault2">
                  <input class="form-check-input" type="radio" name="materai" id="materai" value="0" checked
          ...
          <div class="modal-body d-grid gap-3">
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <input data-bs-toggle="tooltip" type="text" class="form-control date_activity" id="tanggal_bayar"
                  name="tanggal_bayar" placeholder="Tanggal Bayar..." required>

              </div>
            </div>
            <div class="row">
              <label class="col-sm-4 col-form-label" for="">Nominal :<span class="text-danger">*</span></label>
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  <span class="input-group-text" for="">Rp.</span>

                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah" id="terbayar"
                    name="terbayar" placeholder="Nominal..." required onblur="blur_terbayar(this)">
