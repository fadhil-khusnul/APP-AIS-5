                ...
                <div class="portlet-header portlet-header-bordered">
                    ...
                    <div class="header-wrap header-wrap-block justify-content-start">
                        ...
                        <div class="breadcrumb breadcrumb-transparent mb-0">
                            <a href="/invoice-load-create/{{$planload->slug}}" class="breadcrumb-item">
                                <div class="breadcrumb-icon">
                                    <i class="text-primary fa fa-clone"></i>
                                </div>
                                <span class="breadcrumb-text text-primary">Invoice</span>
                            </a>
                    ...
                    <div class="portlet-body row">
                        ...
                        <div class="col-md-12 text-center mb-5">
                            <h3 style="margin-left: auto !important; margin-right:auto !important"
                                class="portlet-title text-center">Invoice-Discharge-{{ $planload->vessel }} ( {{ $planload->select_company }}
                                )</h3>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <div class="col-12"  style="padding-left: 20px; padding-right: 20px">
                                ...
                                <embed src="{{ asset('storage/discharge-invoice/'.$pdf->path.'.pdf') }}"
