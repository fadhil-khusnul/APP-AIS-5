...
@section('content')
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="col-md-12 text-center mb-3">
                            ...
                            <h3 style="margin-left: auto !important; margin-right:auto !important"
                                class="portlet-title text-center"> {{ $plandischarge->vessel }} (
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="col-12 text-center mt-3">
                                <button value="{{ $plandischarge->id }}" type="button" onclick="edit_planloaad_job(this)"
                                    class="btn btn-label-primary">Detail Kapal <i class="fa fa-pencil"></i></button>
                            </div>
                                ...
                                <tbody class="">
                                    @foreach ($containers_barang as $container)
                                        <tr>
                                            ...
                                            <td>{{ $container['nomor_kontainer'] }}</td>
                                            <td>{{ \Carbon\Carbon::parse($container['tanggal_kembali'])->isoFormat('dddd, DD-MMMM-YYYY') }}
                                            </td>
                    ...
                    <div class="modal-body d-grid gap-3 px-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="size" name="size"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="type" name="type"
                                    class="form-select" @readonly(true) required>
                        ...
                        <div class="row ">
                            <label for="" class="col-sm-4 col-form-label">Tanggal Dooring :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="lokasi_kembali" name="lokasi_kembali"
                        ...
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Penerima Barang :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required id="penerima" name="penerima" class="form-select">
                                    ...
                                    @foreach ($penerimas as $penerima)
                                        <option value="{{ $penerima->nama_penerima }}"
                                            @if ($penerima->nama_penerima == $plandischarge->penerima) selected @endif>
                        ...
                        <div class="row">
                            ...
                            <label for="" class="col-sm-4 col-form-label">Alamat Pengantaran :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah "
                                        id="biaya_seal" name="biaya_seal" placeholder="Biaya Seal..." required>

                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-sm-4 col-form-label" for="">Jaminan Kontainer:<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" for="">Rp.</span>
                                    ...
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah "
                                        id="jaminan_kontainer" name="jaminan_kontainer" placeholder="Jaminan Kontainer..." required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                                        id="biaya_thc" name="biaya_thc" placeholder="Biaya THC Lolo..." required
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" for="">Rp.</span>
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                                        id="biaya_trucking" name="biaya_trucking" placeholder="Trucking..." required
                        ...
                        <div class="row ">
                            ...
                            <label for="" class="col-sm-4 col-form-label">Empty Return to:<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">

                                <select required data-bs-toggle="tooltip" id="return_to" name="return_to"
                                    class="form-select" required>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body d-grid gap-3 px-5">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-8 validation-container">
                                <input data-bs-toggle="tooltip" type="text" class="form-control date_activity"
                                    id="tanggal_kembali_edit" name="tanggal_kembali_edit"
                                    placeholder="Tanggal Dooring..." value="" required>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="lokasi_kembali_edit"
                                    name="lokasi_kembali_edit" class="form-select" required>
                                    <option selected disabled value="0">Pilih Lokasi Pickup</option>
                                    @foreach ($lokasis as $lokasi)
                                        <option value="{{ $lokasi->nama_depo }}">
                                            {{ $lokasi->nama_depo }}</option>
                        ...
                        <div class="row">
                            ...
                            <label for="" class="col-sm-4 col-form-label">Alamat Pengantaran :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">
                                <textarea data-bs-toggle="tooltip" class="form-control" id="alamat_pengantaran_edit" name="alamat_pengantaran_edit"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah "
                                        id="jaminan_kontainer_edit" name="jaminan_kontainer_edit" placeholder="Jaminan Kontainer..." required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah "
                                        id="biaya_cleaning_edit" name="biaya_cleaning_edit"
                                        placeholder="Biaya Cleaning..." required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" for="">Rp.</span>
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                                        id="biaya_retribusi_edit" name="biaya_retribusi_edit"
                                        placeholder="Biaya Retribusi..." required>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="return_to_edit" name="return_to_edit"
                                    class="form-select" required>
                                    <option selected disabled value="0">Pilih Lokasi Empty Return</option>
                                    @foreach ($lokasis as $lokasi)
                                        <option value="{{ $lokasi->nama_depo }}">
                    ...
                    <div class="modal-body d-grid gap-3 px-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="size_tambah" name="size_tambah"
                                    class="form-select" @readonly(true) required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="type_tambah" name="type_tambah"
                                    class="form-select" @readonly(true) required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <input required data-bs-toggle="tooltip" type="text"
                                    ...
                                    maxlength="11" name="nomor_kontainer_tambah" onblur="blur_no_container(this)"
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <input required data-bs-toggle="tooltip" type="text" class="form-control"
                                    id="cargo_tambah" name="cargo_tambah" value="{{ old('cargo') }}" required>
                            </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-8 validation-container">
                                <input data-bs-toggle="tooltip" type="text" class="form-control date_activity"
                                    id="tanggal_kembali_tambah" name="tanggal_kembali_tambah"
                                    placeholder="Tanggal Dooring..." value="" required>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="lokasi_kembali_tambah"
                                    name="lokasi_kembali_tambah" class="form-select" required>
                                    <option selected disabled value="0">Pilih Lokasi Pickup</option>
                                    @foreach ($lokasis as $lokasi)
                                        <option value="{{ $lokasi->nama_depo }}">
                                            {{ $lokasi->nama_depo }}</option>
                        ...
                        <div class="row">
                            ...
                            <label for="" class="col-sm-4 col-form-label">Alamat Pengantaran :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">
                                <textarea data-bs-toggle="tooltip" class="form-control" id="alamat_pengantaran_tambah"
                                    name="alamat_pengantaran_tambah" required>{{ old('remark') }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah "
                                        id="biaya_cleaning_tambah" name="biaya_cleaning_tambah"
                                        placeholder="Biaya Cleaning..." required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" for="">Rp.</span>
                                    <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                                        id="biaya_retribusi_tambah" name="biaya_retribusi_tambah"
                                        placeholder="Biaya Retribusi..." required>
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input data-bs-toggle="tooltip" type="text"
                                        class="form-control currency-rupiah" id="ongkos_supir_tambah"
                                        name="ongkos_supir_tambah" placeholder="Ongkos Supir..." required
                                        onblur="validate_ongkos_supir(this)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select required data-bs-toggle="tooltip" id="return_to_tambah"
                                    name="return_to_tambah" class="form-select" required>
                                    <option selected disabled value="0">Pilih Lokasi Empty Return</option>
                                    @foreach ($lokasis as $lokasi)
                                        <option value="{{ $lokasi->nama_depo }}">
                                            {{ $lokasi->nama_depo }}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <input required name="nomor_do" id="nomor_do" class="form-control"
                                    value="{{ old('nomor_do', $plandischarge->nomor_do) }}">
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Tanggal Tiba :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">

                                <input required name="tanggal_tiba" id="tanggal_tiba" class="form-control"
                                    value="{{ old('tanggal_tiba', $plandischarge->tanggal_tiba) }}">


                            </div>
                        </div>
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Vessel/Voyage :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">
                                <input required name="vessel" id="vessel" class="form-control"
                                    value="{{ old('vessel', $plandischarge->vessel) }}">
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Vessel Code :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">

                                <input required name="vessel_code" id="vessel_code" class="form-control"
                                    value="{{ old('vessel_code', $plandischarge->vessel_code) }}">
                                ...
                                <select required id="Pengirim_1" name="Pengirim_1" class="form-select">
                                    ...
                                    @foreach ($pengirim as $pengirim)
                                        <option value="{{ $pengirim->nama_costumer }}"
                                            @if ($pengirim->nama_costumer == $plandischarge->pengirim) selected @endif>
                                            {{ $pengirim->nama_costumer }}</option>
                                    @endforeach
                                </select>
                                ...
                                <select required id="POD_1" name="POD_1" class="form-select">
                                    ...
                                    @foreach ($pod as $pod)
                                        <option value="{{ $pod->nama_pelabuhan }}"
                                            @if ($pod->nama_pelabuhan == $plandischarge->pod) selected @endif>{{ $pod->area_code }} -
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                <div class="input-group input-group-sm">
                                    ...
                                    <input data-bs-toggle="tooltip" type="text"
                                        class="form-control currency-rupiah " value="{{ $plandischarge->biaya_do }}"
                                        id="biaya_do" name="biaya_do" placeholder="Biaya DO..." required>
    ...
    <div class="modal fade" id="modal_detail_barang" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-scrollable">
            <form class="modal-dialog-scrollable" action="#" name="valid_detail_barang"
                id="valid_detail_barang">
                <input type="hidden" name="_token" id="csrf" value="{{ Session::token() }}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body d-grid gap-3 px-5" style="margin-left: 30px">
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Nomor Kontainer :<span
                                    class="text-danger">*</span></label>
                        ...
                        <div id="div_detail" class="row">
                            <div id="body_detail[1]" class="row row-cols g-3">
                                <label id="label_detail" name="label_detail" class="col-sm-4 col-form-label">Detail
                                    Barang Ke-1 :<span class="text-danger">*</span></label>
                                <div id="div_textarea" name="div_textarea"
                    ...
                    <div class="modal-body d-grid gap-3 px-5">
                        <div class="row">
                            <label class="col-sm-4 col-form-label">Nomor Kontainer :<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-8 validation-container">
                                <select disabled data-bs-toggle="tooltip" id="kontainer_detail_edit"
                                    name="kontainer_detail_edit" class="form-select" @readonly(true) required>
                                    <option selected disabled>Pilih Kontainer</option>
    ...
    <div class="modal fade" id="modal_biaya_lainnya" data-bs-backdrop="static">
        <div class="modal-dialog modal-dialog-scrollable">
            <form class="modal-dialog-scrollable" action="#" name="valid_biaya_lainnya"
                id="valid_biaya_lainnya">
                <input type="hidden" name="_token" id="csrf" value="{{ Session::token() }}">
                    ...
                    <div class="modal-body d-grid gap-3 px-5" style="margin-left: 30px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 validation-container">
                                ...
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" for="">Rp.</span>
                                    <input data-bs-toggle="tooltip" type="text"
                                        class="form-control currency-rupiah" id="harga_biaya" name="harga_biaya"
                                        placeholder="Biaya..." value="@rupiah2(old('harga_biaya'))" required>
                        ...
                        <div id="div_biaya" class="row">
                            <div id="body_biaya[1]" class="row row-cols g-3">
                                <label id="label_biaya" name="label_biaya" class="col-sm-4 col-form-label">Keterangan
                                    Biaya Ke-1 :<span class="text-danger">*</span></label>
                    ...
                    <div class="modal-body d-grid gap-3 px-3">
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <select disabled data-bs-toggle="tooltip" id="kontainer_biaya_edit"
                                    name="kontainer_biaya_edit" class="form-select" @readonly(true) required>
                                    <option selected disabled>Pilih Kontainer</option>
                                    @foreach ($select_batal_edit as $container)
                                        <option value="{{ $container->id }}">
                                            {{ $container->nomor_kontainer }}</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 validation-container">
                                ...
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text" for="">Rp.</span>
                                    <input data-bs-toggle="tooltip" type="text"
                                        class="form-control currency-rupiah" id="harga_biaya_edit"
                                        name="harga_biaya_edit" placeholder="Biaya..." value="@rupiah2(old('harga_biaya'))"
                                        required>
