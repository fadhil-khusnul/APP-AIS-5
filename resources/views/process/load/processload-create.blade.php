...
@section('content')
            ...
            <div class="col-md-12 mb-3 table-responsive">
              ...
              <div class="col-12 text-center mt-3">
                <button value="{{ $planload->id }}" type="button" onclick="edit_planloaad_job(this)"
                  class="btn btn-primary">Detail Kapal <i class="fa fa-pencil"></i></button>
              </div>
        ...
        <div class="portlet">
          ...
          <div class="portlet-body">
            ...
            <div class="row row-cols-lg-auto py-3 g-3">
              ...
              <div class="col-12">
                <select multiple aria-placeholder="Pilih Size" id="pilih_size_in" name="pilih_size_in" class="form-select"
                  onchange="fun_pilih_size_in(this)">
              ...
              <table id="table_biaya1" class="table table-bordered table-hover autosize" style="width: 100% !important">
                <thead id="" class="table-success">
                  <tr>
                    ...
                    <th class="text-center">Cargo (Barang)</th>
                    ...
                    <tr>
                      ...
                      <td>
                        <button id="button_kontainer[{{ $loop->iteration }}]"
                          name="button_kontainer[{{ $loop->iteration }}]" class="btn btn-danger btn-icon btn-sm"
                          type="button" value="{{ $container->id }}" onclick="delete_kontainerDB(this)"
                        ...
                        @if ($container->nomor_kontainer != null)
                          <button type="button" id="btn_detail" name="btn_detail"
                            class="btn btn-primary btn-sm text-nowrap" value="{{ $container->id }}"
                            onclick="detail_update(this)">Edit <i class="fa fa-eye"></i></button>
                        @else
                          <button type="button" id="btn_detail" name="btn_detail"
                            class="btn btn-success btn-sm text-nowrap" value="{{ $container->id }}"
                            onclick="detail(this)">Input
            ...
            <div class="mb-5 mt-5">
              ...
              @if ($planload->status == 'Process-Load' || $planload->status == 'Realisasi')
                <button style="float: right" value="{{ $planload->slug }}" type="button"
                  onclick="realisasi_page(this)" class="btn btn-success">Realisasi POL <i
      ...
      <div class="col-md-6">
        <div class="portlet">
          ...
          <div class="portlet-body">
                  ...
                  @foreach ($containers_barang as $container)
                    <tr>
                      ...
                      <td class="text-center text-nowrap">
                        <button id="delete_detail" name="delete_detail" class="btn btn-danger btn-icon btn-sm"
                          type="button" value="{{ $container['id'] }}" onclick="delete_detailbarangDB(this)"
                          @readonly(true)><i class="fa fa-trash"></i></button>
                        <button id="edit_detail" name="edit_detail" class="btn btn-primary btn-icon btn-sm"
                          type="button" value="{{ $container['id'] }}" onclick="detail_barang_edit(this)"
            ...
            <div class="mb-5 mt-5">
              <button id="add_biaya" type="button" onclick="detail_barang()" class="btn btn-success btn-icon"> <i
      ...
      <div class="col-md-6">
        <div class="portlet">
          ...
          <div class="portlet-body">
                  ...
                  @foreach ($new_container_biaya as $biaya)
                    <tr>
                      ...
                      <td class="text-center">
                        <button id="delete_biaya" name="delete_biaya" class="btn btn-danger btn-icon btn-sm"
                          type="button" value="{{ $biaya['id'] }}" onclick="delete_laiannyaDB(this)"
                          @readonly(true)><i class="fa fa-trash"></i></button>
                        <button id="edit_biaya" name="edit_biaya" class="btn btn-primary btn-icon btn-sm"
                          type="button" value="{{ $biaya['id'] }}" onclick="detail_biaya_lain_edit(this)"
                          @readonly(true)><i class="fa fa-pencil"></i></button>
                      </td>
            ...
            <div class="mb-5 mt-5">
              <button id="add_biaya" type="button" onclick="detail_biaya_lain()" class="btn btn-success btn-icon"> <i
                  class="fa fa-plus"></i></button>
            </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-grid gap-3 px-5">
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select required id="pod_container" name="pod_container" class="form-select">
                  ...
                  @foreach ($pods as $pod)
                    <option value="{{ $pod->nama_pelabuhan }}">{{ $pod->nama_pelabuhan }}
                    </option>
                  @endforeach
                </select>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <input required data-bs-toggle="tooltip" type="text" class="form-control nomor_kontainer"
                  id="nomor_kontainer" minlength="11" maxlength="11" name="nomor_kontainer"
            ...
            <div class="row ">
              <label for="" class="col-sm-4 col-form-label">Tanggal Kegiatan :<span
                  class="text-danger">*</span></label>
              <div class="col-sm-8 validation-container">
                <input data-bs-toggle="tooltip" type="text" class="form-control date_activity" id="date_activity"
                  name="date_activity" placeholder="Tanggal Kegiatan..." value="" required>
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select required id="driver" name="driver" class="form-select">
                  ...
                  @foreach ($vendors as $vendor)
                    <option value="{{ $vendor->id }}">{{ $vendor->nama_supir }}/{{ $vendor->nomor_polisi }}
                    </option>
                  @endforeach
                </select>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select data-bs-toggle="tooltip" id="jenis_mobil" name="jenis_mobil" class="form-select" required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah " id="biaya_seal"
                    name="biaya_seal" placeholder="Biaya Seal..." required>
            ...
            @if (count($spks) > 0)
              <div class="row">
                ...
                <div class="col-sm-8 validation-container">
                  <select data-bs-toggle="tooltip" id="spk" name="spk" class="form-select"
                    placeholde="Silahkan Pilih SPK" placeholder = "Pilih SPK">
                    @foreach ($spks as $spk)
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_stuffing" name="biaya_stuffing" placeholder="Biaya Stuffing..." required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  <span class="input-group-text" for="">Rp.</span>
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="ongkos_supir" name="ongkos_supir" placeholder="Ongkos Supir..." required
                    onblur="validate_ongkos_supir(this)">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah" id="biaya_thc"
                    name="biaya_thc" placeholder="Biaya THC..." required>
      ...
      <form class="modal-dialog-scrollable" action="#" name="valid_job_update" id="valid_job_update">
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title" id="nomor_kontainer_title"></h5>
            <button type="button" class="btn btn-label-danger btn-icon" data-bs-dismiss="modal">
              <i class="fa fa-times"></i>
            </button>
          </div>
          <div class="modal-body d-grid gap-3 px-5">
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <input required data-bs-toggle="tooltip" type="text" class="form-control nomor_kontainer"
                  id="nomor_kontainer_update" minlength="11" maxlength="11" name="nomor_kontainer_update"
            ...
            <div class="row ">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <input data-bs-toggle="tooltip" type="text" class="form-control date_activity"
                  id="date_activity_update" name="date_activity_update" placeholder="Tanggal Kegiatan..."
                  value="" required>
            ...
            <div class="row ">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select data-bs-toggle="tooltip" id="lokasi_update" name="lokasi_update" class="form-select" required>
                  <option selected disabled value="0">Pilih Lokasi Pickup</option>
                  @foreach ($lokasis as $lokasi)
                    <option value="{{ $lokasi->nama_depo }}">
                      {{ $lokasi->nama_depo }}</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select data-bs-toggle="tooltip" id="jenis_mobil_update" name="jenis_mobil_update" class="form-select"
                  required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select data-bs-toggle="tooltip" required @readonly(true) id="dana_update" name="dana_update"
                  class="form-select danas">
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_seal_update" name="biaya_seal_update" placeholder="Biaya Seal..." required>
            ...
            @if (count($spks) > 0)
              <div class="row">
                ...
                <div class="col-sm-8 validation-container">
                  ...
                  <select data-bs-toggle="tooltip" id="spk_update" name="spk_update" class="form-select"
                    placeholde="Silahkan Pilih SPK">
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <div class="input-group input-group-sm">
                  <span class="input-group-text" for="">Rp.</span>
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_stuffing_update" name="biaya_stuffing_update" placeholder="Biaya Stuffing..."
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_thc_update" name="biaya_thc_update" placeholder="Biaya THC POL..." required>
          ...
          <div class="modal-body d-grid gap-3 px-5">
            ...
            <div class="row ">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <input disabled data-bs-toggle="tooltip" type="text" class="form-control date_activity"
                  id="date_activity_disabled" name="date_activity_disabled" placeholder="Tanggal Kegiatan..."
                  value="" required>
            ...
            <div class="row ">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select disabled data-bs-toggle="tooltip" id="lokasi_disabled" name="lokasi_disabled"
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select disabled required id="nomor_polisi_disabled" name="nomor_polisi_disabled"
                  class="form-select">
                  @foreach ($vendors2 as $vendor)
                    <option value="{{ $vendor->id }}">{{ $vendor->nama_vendor }}
                    </option>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <textarea disabled data-bs-toggle="tooltip" class="form-control" id="remark_disabled" name="remark_disabled"
                  required>{{ old('remark_disabled') }}</textarea>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <div class="input-group input-group-sm">
                  <span class="input-group-text" for="">Rp.</span>
                  <input disabled data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_stuffing_disabled" name="biaya_stuffing_disabled" placeholder="Biaya Stuffing..."
                    value="@rupiah2(old('biaya_stuffing'))" required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <div class="input-group input-group-sm">
                  ...
                  <input disabled data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_trucking_disabled" name="biaya_trucking_disabled" placeholder="Biaya Trucking..."
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input disabled data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_seal_disabled" name="biaya_seal_disabled" placeholder="Biaya Seal..." required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input disabled data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_thc_disabled" name="biaya_thc_disabled" placeholder="Biaya THC POL..." required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <div class="input-group input-group-sm">
                  ...
                  <input disabled data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="freight_disabled" name="freight_disabled" placeholder="Biaya Freight..." required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <div class="input-group input-group-sm">
                  ...
                  <input disabled data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="lss_disabled" name="lss_disabled" placeholder="Biaya LSS..." required>
            ...
            @if (count($spks) > 0)
              <div class="row">
                ...
                <div class="col-sm-8 validation-container">
                  ...
                  <select disabled data-bs-toggle="tooltip" id="spk_disabled" multiple="multiple"
                    name="spk_disabled" class="form-select" placeholde="Silahkan Pilih SPK">
                    @foreach ($spks as $spk)
                      <option value="{{ $spk->kode_spk }}">
                        {{ $spk->kode_spk }}</option>
                    @endforeach
          ...
          <div class="modal-body d-grid gap-3 px-5">
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <input data-bs-toggle="tooltip" type="text" class="form-control date_activity"
                  id="date_activity_tambah" name="date_activity_tambah" placeholder="Tanggal Kegiatan..." required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_seal_tambah" name="biaya_seal_tambah" placeholder="Biaya Seal..." required>
            ...
            @if (count($spks) > 0)
              <div class="row">
                ...
                <div class="col-sm-8 validation-container">
                  ...
                  <select data-bs-toggle="tooltip" id="spk_tambah" name="spk_tambah" class="form-select"
                    placeholde="Silahkan Pilih SPK">
                    @foreach ($spks as $spk)
                      <option value="{{ $spk->kode_spk }}">
                        {{ $spk->kode_spk }}</option>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  <span class="input-group-text" for="">Rp.</span>
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="biaya_stuffing_tambah" name="biaya_stuffing_tambah" placeholder="Biaya Stuffing..."
                    required>
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="ongkos_supir_tambah" name="ongkos_supir_tambah" placeholder="Ongkos Supir..." required
                    onblur="validate_ongkos_supir_tambah(this)">
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <div class="input-group input-group-sm">
                  ...
                  <input data-bs-toggle="tooltip" oninput="setFormat('biaya_thc');" onkeydown="numbersonly1(this)"
                    pattern="[0-9]" data-type="number" type="text" class="form-control currency-rupiah"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-grid gap-3 px-5" style="margin-left: 30px">
            <div class="row">
              ...
              <div class="col-sm-6 validation-container">
                ...
                <select data-bs-toggle="tooltip" id="kontainer_biaya" name="kontainer_biaya" class="form-select"
                  @readonly(true) required>
                  <option selected disabled>Pilih Kontainer</option>
                  @foreach ($select_biaya as $container)
            ...
            <div class="row">
              <label class="col-sm-4 col-form-label" for="">Total Biaya :<span
                  class="text-danger">*</span></label>
              <div class="col-sm-6 validation-container">
                ...
                <div class="input-group input-group-sm">
                  <span class="input-group-text" for="">Rp.</span>
                  <input data-bs-toggle="tooltip" type="text" class="form-control currency-rupiah"
                    id="harga_biaya" name="harga_biaya" placeholder="Biaya..." value="@rupiah2(old('harga_biaya'))"
                    required>
            ...
            <div id="div_biaya" class="row">
              <div id="body_biaya[1]" class="row row-cols g-3">
                <label id="label_biaya" name="label_biaya" class="col-sm-4 col-form-label">Keterangan Biaya Ke-1
                  :<span class="text-danger">*</span></label>
                <div id="div_textarea_biaya" name="div_textarea_biaya"
                  class="col-sm-6 validation-container d-grid gap-3">
                  <textarea style="margin-left: 10px" data-bs-toggle="tooltip" class="form-control" id="keterangan_biaya[1]"
                    name="keterangan_biaya" placeholder="ex. (Rp. 10.000 untuk kebutuhan kontainer)" required></textarea>
                </div>
                <div id="div_button_biaya" name="div_button_biaya" class="col-sm-2 py-4">
                  <a style="margin-left: 10px" id="hapus_biaya[1]" name="hapus_biaya"
                    class="btn btn-sm btn-label-danger btn-icon" onclick="hapus_biaya(this)"><i
          ...
          <div class="modal-footer">
            <a id="tambah_biaya" type="button" onclick="tambah_keterangan_biaya()"
              class="btn btn-success btn-icon " style="margin-left: 0px; margin-right:auto;"> <i
          ...
          <div class="modal-body d-grid gap-3 px-3">
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select disabled data-bs-toggle="tooltip" id="kontainer_biaya_edit" name="kontainer_biaya_edit"
                  class="form-select" @readonly(true) required>
                  <option selected disabled>Pilih Kontainer</option>
            ...
            <div class="row">
              <label class="col-sm-4 col-form-label" for="">Biaya :<span
                  class="text-danger">*</span></label>
              <div class="col-sm-8 validation-container">
    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <form class="modal-dialog-scrollable" action="#" name="valid_detail_barang" id="valid_detail_barang">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-grid gap-3 px-5" style="margin-left: 30px">
            <div class="row">
              ...
              <div class="col-sm-6 validation-container">
                ...
                <select data-bs-toggle="tooltip" id="kontainer_detail" name="kontainer_detail" class="form-select"
                  @readonly(true) required>
                  <option selected disabled>Pilih Kontainer</option>
            ...
            <div id="div_detail" class="row">
              <div id="body_detail[1]" class="row row-cols g-3">
                <label id="label_detail" name="label_detail" class="col-sm-4 col-form-label">Detail Barang Ke-1
                  :<span class="text-danger">*</span></label>
                <div id="div_textarea" name="div_textarea" class="col-sm-6 validation-container d-grid gap-3">
                  <textarea style="margin-left: 10px" data-bs-toggle="tooltip" class="form-control" id="detail_barang[1]"
                    name="detail_barang" required></textarea>
                </div>
                <div id="div_button" name="div_button" class="col-sm-2 py-4">
                  <a style="margin-left: 10px" id="delete_detail[1]" name="delete_detail"
                    class="btn btn-sm btn-label-danger btn-icon" onclick="delete_detail(this)"><i
                      class="fa fa-trash"></i></a>
                </div>
          ...
          <div class="modal-footer">
            <a id="tambah_barang" type="button" onclick="tambah_barang()" class="btn btn-success btn-icon "
              style="margin-left: 0px; margin-right:auto;"> <i class="fa fa-plus"></i></a>
  ...
  <div class="modal fade" id="modal_detail_barang_edit" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-scrollable">
      <form class="modal-dialog-scrollable" action="#" name="valid_detail_barang_edit"
        id="valid_detail_barang_edit">
        <input type="hidden" name="_token" id="csrf" value="{{ Session::token() }}">
  ...
  <div class="modal fade" id="modal_edit_jobplanload" data-bs-backdrop="static">
    <div class="modal-dialog modal-dialog-scrollable">
      <form class="modal-dialog-scrollable" action="#" name="valid_job_edit_load" id="valid_job_edit_load">
        <input type="hidden" name="_token" id="csrf" value="{{ Session::token() }}">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body d-grid gap-3 px-5">
            ...
            <div class="row">
              <label class="col-sm-4 col-form-label">Jenis Kegiatan(Activity) :<span
                  class="text-danger">*</span></label>
              <div class="col-sm-8 validation-container">
                ...
                <select id="activity" name="activity" class="form-select">
                  ...
                  @foreach ($activity as $activity)
                    <option value="{{ $activity->kegiatan }}" @if ($activity->kegiatan == $planload->activity) selected @endif>
                      {{ $activity->kegiatan }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select id="POL_1" name="POL_1" class="form-select">
                  ...
                  @foreach ($pelabuhans as $pol)
                    <option value="{{ $pol->nama_pelabuhan }}" @if ($pol->nama_pelabuhan == $planload->pol) selected @endif>
                      {{ $pol->area_code }} -
                      {{ $pol->nama_pelabuhan }}
                    </option>
                  @endforeach
            ...
            <div class="row">
              ...
              <div class="col-sm-8 validation-container">
                ...
                <select id="POT_1" name="POT_1" class="form-select">
                  <option selected disabled>Pilih POT</option>
                  @foreach ($pelabuhans as $pot)
                    <option value="{{ $pot->nama_pelabuhan }}" @if ($pot->nama_pelabuhan == $planload->pot) selected @endif>
                      {{ $pot->area_code }} -
                      {{ $pot->nama_pelabuhan }}
                    </option>
                  @endforeach
  ...
  <script type="text/javascript"
    src="{{ asset('/') }}./assets/app/pages/datatable/extension/export_filter_kontainer.js"></script>
