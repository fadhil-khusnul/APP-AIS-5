...
@section('content')
                        ...
                        <div class="col-md-12 mb-3 table-responsive">
                            ...
                            <div class="col-12 text-center mt-3">
                                <button value="{{$planload->id}}" type="button" onclick="edit_planloaad_job(this)"
                                    class="btn btn-label-primary">Edit Detail Kapal Load <i class="fa fa-pencil"></i></button>
                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <button id="button_kontainer[{{ $loop->iteration }}]"
                                                ...
                                                type="button" value="{{$container->id}}" onclick="delete_kontainerDB(this)" @readonly(true)><i
                                        ...
                                        <td>
                                            ...
                                            <button type="button" id="btn_detail" name="btn_detail" class="btn btn-label-primary" value="{{$container->id}}" onclick="detail(this)">Detail Kontainer <i class="fa fa-eye"></i></button>

                                            @else
                                            <button type="button" id="btn_detail" name="btn_detail" class="btn btn-label-success" value="{{$container->id}}" onclick="detail(this)">Detail Kontainer <i class="fa fa-pencil"></i></button>
                                            @endif
                                ...
                                @foreach ($biayas as $biaya)
                                    <tr>
                                        <td class="text-center">
                                            <button id="delete_biaya"
                                                name="delete_biaya"
                                                class="btn btn-label-danger btn-icon btn-circle btn-sm"
                                                type="button" value="{{$biaya->id}}" onclick="delete_laiannyaDB(this)" @readonly(true)><i
                                                    class="fa fa-trash"></i></button>
                                            <button id="edit_biaya"
                                                name="edit_biaya"
                                                class="btn btn-label-primary btn-icon btn-circle btn-sm"
                                                type="button" value="{{$biaya->id}}" onclick="detail_biaya_lain_edit(this)" @readonly(true)><i
                        ...
                        <table id="table_batal_muat" class="table mb-0">
                            ...
                            <tbody id="tbody_batal_muat" class="text-center">
                                @foreach ($container_batal as $container)
                                    <tr>
                                        <td class="text-center">
                                            <button id="delete_batal"
                                                name="delete_batal"
                                                class="btn btn-label-info btn-icon btn-circle btn-sm"
                                                type="button" value="{{$container->id}}" onclick="delete_batalDB(this)" @readonly(true)><i
                                                    class="fa fa-refresh"></i></button>
                                            <button id="edit_batal"
                                                name="edit_batal"
                                                class="btn btn-label-primary btn-icon btn-circle btn-sm"
                                                type="button" value="{{$container->id}}" onclick="detail_batal_muat_edit(this)" @readonly(true)><i
                                                    class="fa fa-pencil"></i></button>
                                        </td>
                                        <td>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="table_alih_kapal" class="table table-responsive mb-0 tabel-fiks">
                                ...
                                <tbody id="tbody_alih" class="text-center">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <button id="delete_alih"
                                                name="delete_alih"
                                                class="btn btn-label-info btn-icon btn-circle btn-sm"
                                                type="button" value="{{$alih->kontainer_alih}}" onclick="delete_alihDB(this)" @readonly(true)><i
                                                    class="fa fa-refresh"></i></button>
                                            <button id="edit_batal"
                                                name="edit_batal"
                                                class="btn btn-label-primary btn-icon btn-circle btn-sm"
                                                type="button" value="{{$alih->id}}" onclick="detail_alih_kapal_edit(this)" @readonly(true)><i
                                                    class="fa fa-pencil"></i></button>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <button type="button" id="btn_detail" name="btn_detail" class="btn btn-label-primary" value="{{$alih->kontainer_alih}}" onclick="detail(this)">Detail Kontainer <i class="fa fa-eye"></i></button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="size"
                    ...
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="type"
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            ...
                            <textarea data-bs-toggle="tooltip" class="form-control" id="detail_barang"
                    ...
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="seal" multiple="multiple"
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            <textarea data-bs-toggle="tooltip" class="form-control" id="remark"
                    ...
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" required @readonly(true)
                            id="dana"
                            name="dana"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="size_tambah"
                            name="size_tambah" class="form-select" @readonly(true)>
                    ...
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="type_tambah"
                            name="type_tambah" class="form-select" @readonly(true) required>
                    ...
                    <div class="validation-container">
                        ...
                        <input data-bs-toggle="tooltip" type="text"
                            class="form-control nomor_kontainer"
                            id="nomor_kontainer_tambah" minlength="11"
                            name="nomor_kontainer_tambah"
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            ...
                            <textarea data-bs-toggle="tooltip" class="form-control" id="detail_barang_tambah"
                                name="detail_barang_tambah" required>{{ old('detail_barang') }}</textarea>
                                <label for="">Detail Barang :<span class="text-danger">*</span></label>
                        </div>
                    ...
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="seal_tambah" multiple="multiple"
                            name="seal_tambah" class="form-select seals" placeholde="Silahkan Pilih Seal" required
                            onchange="change_container(this)">
                            @foreach ($seals as $seal)
                                <option value="{{ $seal->kode_seal }}">
                                    {{ $seal->kode_seal }}</option>
                    ...
                    <div class="validation-container ">
                        ...
                        <input data-bs-toggle="tooltip" type="text"
                            class="form-control date_activity"
                            id="date_activity_tambah"
                            name="date_activity_tambah"
                    ...
                    <div class="validation-container ">
                        ...
                        <input data-bs-toggle="tooltip" type="text"
                            class="form-control" id="driver_tambah"
                            name="driver_tambah" placeholder="Nama Driver..."
                            required>
                            <label for="">Nama Driver :<span class="text-danger">*</span></label>
                    ...
                    <div class="validation-container">
                        ...
                        <input data-bs-toggle="tooltip" type="text"
                            class="form-control"
                            id="nomor_polisi_tambah"
                            name="nomor_polisi_tambah"
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            <textarea data-bs-toggle="tooltip" class="form-control" id="remark_tambah"
                            name="remark_tambah" required></textarea>
                            <label for="">Remark :<span class="text-danger">*</span></label>
                    ...
                    <div class="validation-container">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            onkeyup="javascript:tandaPemisahTitik(this);" type="text"
                            class="form-control"
                            id="biaya_stuffing_tambah"
                            name="biaya_stuffing_tambah"
                    ...
                    <div class="validation-container">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input data-bs-toggle="tooltip"
                                ...
                                onkeyup="javascript:tandaPemisahTitik(this);" type="text"
                                class="form-control"
                                id="biaya_trucking_tambah"
                                name="biaya_trucking_tambah"
                    ...
                    <div class="validation-container">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input data-bs-toggle="tooltip"
                                ...
                                onkeyup="javascript:tandaPemisahTitik(this);" type="text"
                                class="form-control"
                                id="ongkos_supir_tambah"
                                name="ongkos_supir_tambah"
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            ...
                            <select data-bs-toggle="tooltip"
                            id="jenis_mobil_tambah"
                            name="jenis_mobil_tambah"
                            class="form-select" required>
                    ...
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" @readonly(true)
                            id="dana_tambah"
                            name="dana_tambah"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="kontainer_biaya"
                            name="kontainer_biaya" class="form-select" @readonly(true) required>
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            ...
                            <textarea data-bs-toggle="tooltip" class="form-control" id="keterangan"
    ...
    <div class="modal fade" id="modal_biaya_lainnya_edit">
        <div class="modal-dialog modal-dialog-scrollable">
            <form class="modal-dialog-scrollable" action="#" name="valid_biaya_lainnya_edit" id="valid_biaya_lainnya_edit">
                <input type="hidden" name="_token" id="csrf" value="{{ Session::token() }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="kontainer_biaya_edit"
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            ...
                            <textarea data-bs-toggle="tooltip" class="form-control" id="keterangan_edit"
                                name="keterangan_edit" required>{{ old('keterangan') }}</textarea>
                                <label for="">Keterangan Biaya :<span class="text-danger">*</span></label>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="kontainer_batal"
                            name="kontainer_batal" class="form-select" @readonly(true) required>
                            <option selected disabled>Pilih Kontainer</option>
                            @foreach ($containers as $container)
                    ...
                    <div class="validation-container">
                        <label class="label-text" for="">Biaya Batal Muatan :<span class="text-danger">*</span></label>
                        <div class="input-group input-group-sm">
                            <span class="input-group-text" for="">Rp.</span>
                            <input data-bs-toggle="tooltip"
                            onkeydown="return numbersonly(this, event);"
                            ...
                            id="harga_batal"
                            name="harga_batal"
                            placeholder="Biaya Batal Muatan..." value="@rupiah2(old('harga_batal'))" required>
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            ...
                            <textarea data-bs-toggle="tooltip" class="form-control" id="keterangan_batal"
                                name="keterangan_batal" required>{{ old('keterangan_batal') }}</textarea>
    ...
    <div class="modal fade" id="modal_batal_muat_edit">
        <div class="modal-dialog modal-dialog-scrollable">
            <form class="modal-dialog-scrollable" action="#" name="valid_batal_muat_edit" id="valid_batal_muat_edit">
                <input type="hidden" name="_token" id="csrf" value="{{ Session::token() }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="kontainer_batal_edit"
                            name="kontainer_batal_edit" class="form-select" @disabled(true) @readonly(true) required>
                            <option selected disabled>Pilih Kontainer</option>
                            @foreach ($select_batal_edit as $container)
                                <option value="{{ $container->id }}">
                                    {{ $container->nomor_kontainer }}</option>
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            ...
                            <textarea data-bs-toggle="tooltip" class="form-control" id="keterangan_batal_edit"
                                name="keterangan_batal_edit" required>{{ old('keterangan_batal_edit') }}</textarea>
                                <label for="">Keterangan Batal Muat :<span class="text-danger">*</span></label>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    <div class="validation-container">
                        ...
                        <select data-bs-toggle="tooltip" id="kontainer_alih"
                            name="kontainer_alih" class="form-select" @readonly(true) required>
                            <option selected disabled>Pilih Kontainer</option>
                    ...
                    <div class="validation-container">
                        <label for="email">Pilih Pelayaran (Shipping Company) :<span class="text-danger">*</span></label>
                    ...
                    <div class="validation-container">
                        <label class="label-text" for="">Biaya Alih Kapal<span class="text-danger">*</span></label>
                        <div class="input-group input-group-sm">
                            <span class="input-group-text" for="">Rp.</span>
                            <input data-bs-toggle="tooltip"
                            onkeydown="return numbersonly(this, event);"
                            ...
                            id="harga_alih"
                            name="harga_alih"
                            placeholder="Biaya Alih Kapal..." required>
    ...
    <div class="modal fade" id="modal_alih_kapal_edit">
        <div class="modal-dialog modal-dialog-scrollable">
            <form class="modal-dialog-scrollable" action="#" name="valid_alih_kapal_edit" id="valid_alih_kapal_edit">
                <input type="hidden" name="_token" id="csrf" value="{{ Session::token() }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    ...
                    <div class="validation-container">
                        <label for="email">Vessel Code : <span class="text-danger">*</span></label>
                        <input required class="form-control" type="text" name="vessel_code_alih_edit" id="vessel_code_alih_edit">
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            ...
                            <textarea data-bs-toggle="tooltip" class="form-control" id="keterangan_alih_edit" placeholder="Keterangan Alih Kapal"
                                name="keterangan_alih_edit" required>{{ old('keterangan_alih_edit') }}</textarea>
                                <label for="">Keterangan Alih Kapal :<span class="text-danger">*</span></label>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body d-grid gap-3">
                    <div class="validation-container">
                        <div class="form-floating">
                        <input type="text" class="form-control" id="vessel" name="vessel" value="{{ $planload->vessel }}">
                        <label for="email">Vessel/Voyage :<span class="text-danger">*</span></label>
                    ...
                    <div class="validation-container">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="vessel_code" name="vessel_code" value="{{$planload->vessel_code }}">
                        <label for="email">Vessel Code :<span class="text-danger">*</span></label>

                        </div>
                    </div>
                    <div class="validation-container">
                        <label for="email">Shipping Company (Pelayaran) :<span class="text-danger">*</span></label>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success">Edit Detail Kapal {{$planload->vessel}}</button>
                    <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal">Close</button>
                </div>
            </div>
