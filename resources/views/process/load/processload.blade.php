            ...
            <div class="portlet">
                ...
                <div class="portlet-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="planload" class="align-top table mb-0 table-bordered table-striped table-hover autosize">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Vessel</th>
                                                ...
                                                <ol start="1">
                                                    @foreach ($alihkapal as $alih)
                                                        @if ($planload->id == $alih->job_id)
                                                            <li>
                                                                {{ $alih->kontainer_alih }} - {{$alih->harga_alih_kapal}} - {{$alih->keterangan_alih_kapal}}
                                                            </li>
                                                        @endif
                                                    @endforeach
                                                ...
                                                <ol start="1">
                                                    @foreach ($batalmuat as $batal)
                                                        @if ($planload->id == $batal->job_id)
                                                            <li>
                                                                {{ $batal->kontainer_batal }} - {{$batal->harga_batal_muat}} - {{$batal->keterangan_batal_muat}}
                                                            </li>
                                                        @endif
                                                    @endforeach
